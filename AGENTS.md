...
FastAPI demo app for Deepgram Text-to-Speech.
...
```
feat(fastapi-text-to-speech): add diarization support
fix(fastapi-text-to-speech): resolve WebSocket close handling
refactor(fastapi-text-to-speech): simplify session endpoint
